...
export const Content = () => {
    return createElement('article', {class: 'note-content'},
        createElement('h1', {class: 'note-title'}, 'Einkaufen'),
        createElement('p', {class: 'note-text'}, `Weit hinten, hinter den Wortbergen, fern der Länder Vokalien und Konsonantien leben die
