...
export const ContentHeaderButtons = () => {
    return createElement('div', {class: "header-actions"},
        createElement('button', {class: "button-base icon-button-small button-rounded edit-button"},
            createElement('svg', {
        ...
        createElement('button', {class: "button-base button-outline icon-button-small button-rounded done-button"},
            createElement('svg', {
                    width: "16", height: "16", viewBox: "0 0 16 16", fill: "none",
                    xmlns: "http://www.w3.org/2000/svg"
                },
